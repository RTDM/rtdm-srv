...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("rtdm rtdm 3686a087-6c5d-49e7-ad9a-beb3458292d4 7696796425273206004".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in rtdm package as a set of config entries
        return configLoader.fromResource("rtdm/settings");
    }
